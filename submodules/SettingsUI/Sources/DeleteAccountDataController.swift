    ...
    func item(presentationData: ItemListPresentationData, arguments: Any) -> ListViewItem {
        ...
        switch self {
            case let .header(theme, animation, title, text, hideOnSmallScreens):
                return InviteLinkHeaderItem(context: arguments.context, strings: presentationData.strings, theme: theme, title: title, text: NSAttributedString(string: text), animationName: animation, hideOnSmallScreens: hideOnSmallScreens, sectionId: self.section, linkAction: nil)
