    ...
    func item(presentationData: ItemListPresentationData, arguments: Any) -> ListViewItem {
        ...
        switch self {
            case let .header(theme, text):
                return InviteLinkHeaderItem(context: arguments.context, strings: presentationData.strings, theme: theme, text: NSAttributedString(string: text), animationName: "Requests", sectionId: self.section, linkAction: { _ in
                    arguments.openLinks()
                })
