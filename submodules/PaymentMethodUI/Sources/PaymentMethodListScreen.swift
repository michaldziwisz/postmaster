...
private enum InviteLinksListEntry: ItemListNodeEntry {
    ...
    func item(presentationData: ItemListPresentationData, arguments: Any) -> ListViewItem {
        ...
        case let .header(text):
            return InviteLinkHeaderItem(context: arguments.context, strings: presentationData.strings, theme: presentationData.theme, text: NSAttributedString(string: text), animationName: "Invite", sectionId: self.section)
